...
router.get("/", (req, res) => {
  Board.findAll().then(boardsArray => {
    ...
    // someFunction();
    boardsArray.forEach((element)=>{
      element.dataValues["images"] = ["https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQMifmGSN85hcY8wwfIixNZFAVqBYmN7Sdt1i4rdGoE3QUjDjKP","https://i.pinimg.com/736x/2f/56/bd/2f56bd2ca239bdd0c739a7ad7c21361f--surfboard-art-surf-boards.jpg"]
    })
    return boardsArray
  }).then((boardsArray)=>{
